...
// accent, the name, the tagline and Cellar's lowercase voice differ.
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        ...
        >
          <View className="items-center gap-2">
            ...
            <Text className="text-4xl font-bold tracking-tight text-foreground">cellar</Text>
            <Text className="text-center text-muted-foreground">every half-thought about every project, in one place.</Text>
